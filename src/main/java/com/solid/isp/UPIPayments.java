 ...
 * split into smaller ones. Because the implementation classes
 * use only the methods
 * that are required. We should not force the client to use the methods
 ...
 * Let's understand the principle though an example
 */
